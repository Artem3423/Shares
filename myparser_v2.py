...
def get_content(html):
    ...
    for i in range(1, 1000000):
        ...
        if str(pair).count(str(i)) == 0 or str(pair).count('USD/RUB') == 0 or str(pair).count('EUR/RUB') == 0 or str(pair).count('USD/EUR') == 0 or str(pair).count('EUR/USD') == 0:
            continue

        print(i)

        print(pair)
        #if str(pair).count('USD/RUB') != 0 or str(pair).count('EUR/RUB') != 0 or str(pair).count('USD/EUR') != 0 or str(pair).count('EUR/USD') != 0:
        #    vr += 1
